//Test client for CSC 2431 HW2.  Updated 4/15/16
// to fix typos, make more consistent.
...
int main()
{
	...
	//swag->printCoins();	//temp for testing 
	...
	//swag->printCoins();	//temp for testing 25 10 1 10 25 1
	swag->removeCoin(silver);
	//swag->printCoins();	//temp for testing  25 1 10 25 1
	swag->removeCoin(copper);
	//swag->printCoins(); //25 10 25 1
